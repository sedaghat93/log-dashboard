...
//   const { data: logErrorsData, isLoading, isError } = useQuery(
//     "logErrorsData",
//     async () => {
//       const response = await axios.get(url_real, {
//         headers: {
...
//       const currentIndex = logErrorsData.findIndex(
//         (logError) => logError.id === selectedPoint
//       );
//       const previousPage = Math.floor(currentIndex / pageSize) + 1;
//       setCurrentPage(previousPage);
//     }
//   }, [selectedPoint, logErrorsData, isLoading, isError]);
...
//   const currentData = logErrorsData?.slice(startIndex, endIndex);
...
//       ) : (
//         <>
//           <RechartError data={logErrorsData} handlePointClick={handlePointClick} />
